 ...
 */
final class Version20251215082918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity_log (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, action VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', target_data VARCHAR(255) NOT NULL, INDEX IDX_FD06F6479D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `rank` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, abbreviation VARCHAR(20) NOT NULL, branch VARCHAR(50) DEFAULT NULL, category VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, unit_id INT DEFAULT NULL, item_status VARCHAR(255) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C42F7784A76ED395 (user_id), INDEX IDX_C42F7784F8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE unit_instance (id INT AUTO_INCREMENT NOT NULL, weapon_type_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, unit_type_id INT DEFAULT NULL, serial_number VARCHAR(10) NOT NULL, purchased_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', status VARCHAR(255) NOT NULL, item_status VARCHAR(255) NOT NULL, INDEX IDX_370E5B4C607BCCD7 (weapon_type_id), INDEX IDX_370E5B4C7E3C61F9 (owner_id), INDEX IDX_370E5B4C91058251 (unit_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_rank_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, contact_number VARCHAR(255) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, INDEX IDX_8D93D6492E1B7985 (user_rank_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784F8BD700D FOREIGN KEY (unit_id) REFERENCES unit_instance (id)');
        ...
        $this->addSql('ALTER TABLE unit_instance ADD CONSTRAINT FK_370E5B4C91058251 FOREIGN KEY (unit_type_id) REFERENCES unit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE unit_instance DROP FOREIGN KEY FK_370E5B4C91058251');
